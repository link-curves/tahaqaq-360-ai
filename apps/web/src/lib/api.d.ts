...
declare class ApiClient {
    ...
    getFactChecks(params?: FactCheckParams): Promise<PaginatedResponse<FactCheck>>;
    ...
    verifyCertificate(verificationCode: string): Promise<ApiResponse<Certificate>>;
    getPlatformStats(): Promise<ApiResponse<PlatformStats>>;
    createSubmission(data: CreateSubmissionRequest): Promise<ApiResponse<Submission>>;
    getMySubmissions(params?: PaginationParams): Promise<PaginatedResponse<Submission>>;
